...
export const AUTH_API = import.meta.env.VITE_AUTH_API || 'http://localhost:8000/api';
export const USER_API = import.meta.env.VITE_USER_API || 'http://localhost:8001/api';
export const MEDICAL_API = import.meta.env.VITE_MEDICAL_API || 'http://localhost:8002/api/v1';
export const APPOINTMENT_API = import.meta.env.VITE_APPOINTMENT_API || 'http://localhost:8003/api';
